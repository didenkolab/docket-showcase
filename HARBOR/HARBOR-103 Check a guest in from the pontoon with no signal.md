...
logged: ["[[HARBOR-146 Queue flush against a phone with no signal]]", "[[HARBOR-147 Showing the queued state on the check-in screen]]", "[[HARBOR-149 Pontoon flow written up for review]]", "[[HARBOR-150 Wet-hands pass over the check-in screen]]", "[[HARBOR-151 Check-in tested on the pontoon at Vik]]", "[[HARBOR-152 Fixing what came back from the pontoon]]", "[[HARBOR-154 Second pass, and the papers photograph]]", "[[HARBOR-155 Closing the pontoon story]]"]
