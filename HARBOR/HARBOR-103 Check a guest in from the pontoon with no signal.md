...
logged: ["[[HARBOR-146 Queue flush against a phone with no signal]]", "[[HARBOR-147 Showing the queued state on the check-in screen]]", "[[HARBOR-149 Pontoon flow written up for review]]", "[[HARBOR-150 Wet-hands pass over the check-in screen]]"]
